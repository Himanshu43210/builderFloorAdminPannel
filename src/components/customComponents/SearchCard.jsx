...
export default function SearchCard({
  element = {
    ...
    detailTitle:
      "4BHK Ultra luxury Brand New Builder Floor Available for Sale in DLF PHASE 3 Gurgaon",
    description:
    ...
    thumbnails: ["uploads/S25-1 DLF3/1st Floor/THUMBNAIL 1.jpg"],
  ...
  const useStyles = makeStyles((theme) => ({
    ...
    leftImage: {
      width: "20%", // Set left image width to 30%
      height: "auto",
      objectFit: "cover",
    },
    content: {
      height: "100%",
      width: "fit-screen", // Set right content width to 70%
      display: "flex",
  ...
  return (
    <Card className={classname} sx={{ width: "80%" }}>
      <CardActionArea
        style={{ display: "flex", margin: "auto", marginLeft: "1px" }}
        className="searchcardiv"
      >
        <CardMedia
